...
function TheAuthors() {
  return (
    <Container>
      <h1>Authors from the Continent</h1>
      <Row>
        <Col>
          <Accordion>
        ...
        <Col>
          <Accordion>
            ...
            <Accordion.Collapse eventKey="0">
              <Card.Body className="profile-bg"><Col>Geralt of Rivia <br /> Geralt is a Witcher from the School of the Wolf . Though his backstory may be filled with darkness and very little happiness he manages to find slivers of happiness on the Continent where he has met friends such as Jaskier and Yennefer. Geralt doesn’t talk much, but that hasn’t stopped him from giving his take on some of the culinary experiences he's enjoyed on his travels . If ever you find a monter near home, simply “Toss a coin to your Witcher”</Col></Card.Body>
            </Accordion.Collapse>
          </Accordion>
        </Col>
        <Col>
