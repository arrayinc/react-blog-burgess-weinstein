...
const AuthorInfoSection = (props) => {
  return (
    <div className="author-info">
      <h1 className="author-name greatprimer-font">
        {props.blogData.author.name}
      </h1>
      <h1 className="author-username greatprimer-font">
        {props.blogData.author.username}
      </h1>
      <p className="author-about greatprimer-font">
        {props.blogData.author.about}
      </p>
    </div>
  );
};
    ...
    <div className="author-body">
      ...
      <Container className="author-bio-container">
        ...
        <AuthorInfoSection
          ...
          blogData={props.blogData[authorId]}
        />
      </Container>
    </div>
  );
